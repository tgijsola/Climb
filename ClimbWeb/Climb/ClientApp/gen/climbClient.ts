...
export class AccountApi extends BaseClass {
    ...
    constructor(baseUrl?: string, http?: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> }) {
        ...
        this.baseUrl = baseUrl ? baseUrl : this.getBaseUrl("https://localhost:44349");
    }
...
export class GameApi extends BaseClass {
    ...
    create(name: string | null, charactersPerMatch: number, maxMatchPoints: number, hasStages: boolean): Promise<Game> {
        ...
        if (hasStages === undefined || hasStages === null)
            throw new Error("The parameter 'hasStages' must be defined and cannot be null.");
        else
            url_ += "hasStages=" + encodeURIComponent("" + hasStages) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
...
export class SetApi extends BaseClass {
    ...
    challengeUser(requesterID: number, challengedID: number): Promise<SetRequest> {
