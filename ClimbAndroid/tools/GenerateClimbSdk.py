...
subprocess.run("java -jar swagger-codegen-cli.jar generate -i http://192.168.196.1:45455/swagger/v1/swagger.json --model-package Climb.Models --api-package Climb.API --invoker-package Climb -l android --library=volley -o .\\tmp\\", shell=True, check=True)
